  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        width: 400,
        height: 400,
        background: 'radial-gradient(circle, rgba(13, 122, 110, 0.05) 0%, transparent 70%)',
        filter: 'blur(70px)',
        zIndex: 0,
        pointerEvents: 'none',
      }} />
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              border: '1px solid rgba(0, 163, 92, 0.15)',
            ...
            <div className="hero-checklist-container hide-on-mobile">
              ...
              <div className="hero-checklist-row">
                <div style={{
                  ...
                  height: 22,
                  borderRadius: '50%',
                  background: 'rgba(250, 110, 57, 0.12)',
              ...
              <div className="hero-checklist-row">
                <div style={{
                  ...
                  height: 22,
                  borderRadius: '50%',
                  background: 'rgba(75, 123, 242, 0.12)',
                  color: '#4b7bf2',
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
